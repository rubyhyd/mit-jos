	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800272:	0f be 80 a8 10 80 00 	movsbl 0x8010a8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800392:	ff 24 8d 60 11 80 00 	jmp    *0x801160(,%ecx,4)
  ...
  800456:	c7 44 24 08 c9 10 80 	movl   $0x8010c9,0x8(%esp)
  80045d:	00 
  ...
  800488:	75 05                	jne    80048f <vprintfmt+0x188>
				p = "(null)";
  80048a:	be b9 10 80 00       	mov    $0x8010b9,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800b0a:	00 
  800b0b:	c7 44 24 08 e8 12 80 	movl   $0x8012e8,0x8(%esp)
  800b12:	00 
  800b13:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b1a:	00 
  800b1b:	c7 04 24 05 13 80 00 	movl   $0x801305,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b9c:	00 
  800b9d:	c7 44 24 08 e8 12 80 	movl   $0x8012e8,0x8(%esp)
  800ba4:	00 
  800ba5:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bac:	00 
  800bad:	c7 04 24 05 13 80 00 	movl   $0x801305,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bef:	00 
  800bf0:	c7 44 24 08 e8 12 80 	movl   $0x8012e8,0x8(%esp)
  800bf7:	00 
  800bf8:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800bff:	00 
  800c00:	c7 04 24 05 13 80 00 	movl   $0x801305,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c42:	00 
  800c43:	c7 44 24 08 e8 12 80 	movl   $0x8012e8,0x8(%esp)
  800c4a:	00 
  800c4b:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800c52:	00 
  800c53:	c7 04 24 05 13 80 00 	movl   $0x801305,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c95:	00 
  800c96:	c7 44 24 08 e8 12 80 	movl   $0x8012e8,0x8(%esp)
  800c9d:	00 
  800c9e:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800ca5:	00 
  800ca6:	c7 04 24 05 13 80 00 	movl   $0x801305,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800ce8:	00 
  800ce9:	c7 44 24 08 e8 12 80 	movl   $0x8012e8,0x8(%esp)
  800cf0:	00 
  800cf1:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800cf8:	00 
  800cf9:	c7 04 24 05 13 80 00 	movl   $0x801305,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  800d5d:	00 
  800d5e:	c7 44 24 08 e8 12 80 	movl   $0x8012e8,0x8(%esp)
  800d65:	00 
  800d66:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800d6d:	00 
  800d6e:	c7 04 24 05 13 80 00 	movl   $0x801305,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800db0:	c7 04 24 14 13 80 00 	movl   $0x801314,(%esp)
  ...
  800dc6:	e8 52 f3 ff ff       	call   80011d <vcprintf>
	cprintf("\n");
  800dcb:	c7 04 24 9c 10 80 00 	movl   $0x80109c,(%esp)
