...
.LM17:
	...
	.p2align 3
.L11:
	.stabn	68,0,78,.LM18-.LFBB3
.LM18:
	movl	$0, (%esp)
	call	monitor
	jmp	.L11
.L13:
	.stabn	68,0,64,.LM19-.LFBB3
.LM19:
	movl	%esi, panicstr
...
.LM27:
	...
	movl	32(%esp), %eax
	movl	%eax, 4(%esp)
	.stabn	68,0,87,.LM28-.LFBB4
.LM28:
	leal	44(%esp), %ebx
	.stabn	68,0,88,.LM29-.LFBB4
.LM29:
	call	cprintf
	.stabn	68,0,89,.LM30-.LFBB4
.LM30:
	movl	40(%esp), %eax
	movl	%ebx, 4(%esp)
	movl	%eax, (%esp)
	call	vcprintf
	.stabn	68,0,90,.LM31-.LFBB4
.LM31:
	movl	$.LC4, (%esp)
	call	cprintf
	.stabn	68,0,92,.LM32-.LFBB4
.LM32:
	addl	$24, %esp
	.cfi_def_cfa_offset 8
	popl	%ebx
