...
umain(int argc, char **argv)
{
  ...
  800059:	c7 04 24 60 0e 80 00 	movl   $0x800e60,(%esp)
...
libmain(int argc, char **argv)
{
  ...
  800093:	e8 13 08 00 00       	call   8008ab <memset>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80020b:	e8 a0 09 00 00       	call   800bb0 <__udivdi3>
  ...
  800269:	e8 72 0a 00 00       	call   800ce0 <__umoddi3>
  80026e:	89 7c 24 04          	mov    %edi,0x4(%esp)
  800272:	0f be 80 78 0e 80 00 	movsbl 0x800e78(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800392:	ff 24 8d 20 0f 80 00 	jmp    *0x800f20(,%ecx,4)
  ...
  800456:	c7 44 24 08 99 0e 80 	movl   $0x800e99,0x8(%esp)
  80045d:	00 
  ...
  800488:	75 05                	jne    80048f <vprintfmt+0x188>
				p = "(null)";
  80048a:	be 89 0e 80 00       	mov    $0x800e89,%esi
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800b0a:	00 
  800b0b:	c7 44 24 08 a0 10 80 	movl   $0x8010a0,0x8(%esp)
  800b12:	00 
  800b13:	c7 44 24 04 23 00 00 	movl   $0x23,0x4(%esp)
  800b1a:	00 
  800b1b:	c7 04 24 bd 10 80 00 	movl   $0x8010bd,(%esp)
  800b22:	e8 29 00 00 00       	call   800b50 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800b55:	83 ec 20             	sub    $0x20,%esp
	...
	va_start(ap, fmt);
  800b58:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800b5b:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800b61:	e8 c9 ff ff ff       	call   800b2f <sys_getenvid>
  800b66:	8b 55 0c             	mov    0xc(%ebp),%edx
  800b69:	89 54 24 10          	mov    %edx,0x10(%esp)
  800b6d:	8b 55 08             	mov    0x8(%ebp),%edx
  800b70:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800b74:	89 74 24 08          	mov    %esi,0x8(%esp)
  800b78:	89 44 24 04          	mov    %eax,0x4(%esp)
  800b7c:	c7 04 24 cc 10 80 00 	movl   $0x8010cc,(%esp)
  800b83:	e8 f6 f5 ff ff       	call   80017e <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800b88:	89 5c 24 04          	mov    %ebx,0x4(%esp)
  800b8c:	8b 45 10             	mov    0x10(%ebp),%eax
  800b8f:	89 04 24             	mov    %eax,(%esp)
  800b92:	e8 86 f5 ff ff       	call   80011d <vcprintf>
	cprintf("\n");
  800b97:	c7 04 24 6c 0e 80 00 	movl   $0x800e6c,(%esp)
  800b9e:	e8 db f5 ff ff       	call   80017e <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  800ba3:	cc                   	int3   
  800ba4:	eb fd                	jmp    800ba3 <_panic+0x53>
