	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80025e:	0f be 80 71 0e 80 00 	movsbl 0x800e71(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800422:	c7 44 24 08 89 0e 80 	movl   $0x800e89,0x8(%esp)
  800429:	00 
  ...
  800442:	c7 44 24 08 92 0e 80 	movl   $0x800e92,0x8(%esp)
  800449:	00 
  ...
  800474:	75 05                	jne    80047b <vprintfmt+0x188>
				p = "(null)";
  800476:	be 82 0e 80 00       	mov    $0x800e82,%esi
			if (width > 0 && padc != '-')
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800b7e:	e8 86 f5 ff ff       	call   800109 <vcprintf>
	cprintf("\n");
  800b83:	c7 04 24 d0 10 80 00 	movl   $0x8010d0,(%esp)
