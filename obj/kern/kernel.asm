...
f01000c0:	e8 b2 13 00 00       	call   f0101477 <memset>
...
f0100494:	e8 2b 10 00 00       	call   f01014c4 <memmove>
...
f0100641:	c7 04 24 b0 19 10 f0 	movl   $0xf01019b0,(%esp)
f0100648:	e8 d4 02 00 00       	call   f0100921 <cprintf>
}
...
f01008e7:	e8 69 fd ff ff       	call   f0100655 <cputchar>
	*cnt++;
}
f01008ec:	c9                   	leave  
f01008ed:	c3                   	ret    
...
f0100a54:	b8 7a 71 10 f0       	mov    $0xf010717a,%eax
f0100a59:	3d c1 58 10 f0       	cmp    $0xf01058c1,%eax
...
f0100a7d:	e8 76 f6 ff ff       	call   f01000f8 <_panic>
	...
	// String table validity checks
	if (stabstr_end <= stabstr || stabstr_end[-1] != 0)
f0100a82:	80 3d 79 71 10 f0 00 	cmpb   $0x0,0xf0107179
...
f0100a96:	b8 c0 58 10 f0       	mov    $0xf01058c0,%eax
...
f0100b10:	b9 7a 71 10 f0       	mov    $0xf010717a,%ecx
f0100b15:	81 e9 c1 58 10 f0    	sub    $0xf01058c1,%ecx
f0100b1b:	39 c8                	cmp    %ecx,%eax
f0100b1d:	73 08                	jae    f0100b27 <debuginfo_eip+0x10f>
			info->eip_fn_name = stabstr + stabs[lfun].n_strx;
f0100b1f:	05 c1 58 10 f0       	add    $0xf01058c1,%eax
...
f0100b82:	ba 7a 71 10 f0       	mov    $0xf010717a,%edx
f0100b87:	81 ea c1 58 10 f0    	sub    $0xf01058c1,%edx
f0100b8d:	39 d0                	cmp    %edx,%eax
f0100b8f:	73 07                	jae    f0100b98 <debuginfo_eip+0x180>
		info->eip_file = stabstr + stabs[lline].n_strx;
f0100b91:	05 c1 58 10 f0       	add    $0xf01058c1,%eax
...
f0101247:	e8 2a f4 ff ff       	call   f0100676 <iscons>
...
f010124e:	be 00 00 00 00       	mov    $0x0,%esi
	...
	while (1) {
		c = getchar();
f0101253:	e8 0d f4 ff ff       	call   f0100665 <getchar>
...
f010128e:	e8 c2 f3 ff ff       	call   f0100655 <cputchar>
			i--;
...
f01012ac:	e8 a4 f3 ff ff       	call   f0100655 <cputchar>
			buf[i++] = c;
...
f01012d1:	e8 7f f3 ff ff       	call   f0100655 <cputchar>
			buf[i] = 0;
