	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800236:	0f be 80 51 0e 80 00 	movsbl 0x800e51(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003fa:	c7 44 24 08 69 0e 80 	movl   $0x800e69,0x8(%esp)
  800401:	00 
  ...
  80041a:	c7 44 24 08 72 0e 80 	movl   $0x800e72,0x8(%esp)
  800421:	00 
  ...
  80044c:	75 05                	jne    800453 <vprintfmt+0x188>
				p = "(null)";
  80044e:	be 62 0e 80 00       	mov    $0x800e62,%esi
			if (width > 0 && padc != '-')
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800b56:	e8 86 f5 ff ff       	call   8000e1 <vcprintf>
	cprintf("\n");
  800b5b:	c7 04 24 b0 10 80 00 	movl   $0x8010b0,(%esp)
